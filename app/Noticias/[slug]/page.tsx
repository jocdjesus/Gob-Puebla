...
function getNoticiaIcon(titulo: string, contenido: string) {
  ...
  if (texto.includes("deporte"))
    return <Trophy className="noticia-slug-icon noticia-slug-icon-yellow" />;
  if (texto.includes("seguridad"))
    return <Shield className="noticia-slug-icon noticia-slug-icon-blue" />;
  if (texto.includes("educación"))
    return (
      <GraduationCap className="noticia-slug-icon noticia-slug-icon-green" />
    );
  if (texto.includes("ambiente"))
    return <Leaf className="noticia-slug-icon noticia-slug-icon-emerald" />;
  if (texto.includes("gobierno"))
    return <Building2 className="noticia-slug-icon noticia-slug-icon-purple" />;
  if (texto.includes("mujer"))
    return <Heart className="noticia-slug-icon noticia-slug-icon-pink" />;
...
export default async function NoticiaPage({
  ...
  const todasLasImagenes = [imagenPrincipal, ...imagenesSecundarias].filter(
    Boolean,
  );
      ...
      <header className="noticia-slug-header">
        <div className="noticia-slug-header-container">
          ...
          <nav className="noticia-slug-nav hidden md-flex">
            <Link href="/" className="noticia-slug-nav-link">
              Inicio
            </Link>
            <Link href="/Noticias" className="noticia-slug-nav-link">
              Noticias
            </Link>
          </nav>
        </div>
      ...
      <main className="noticia-slug-main">
        <div className="noticia-slug-content-max">
          ...
          <div className="noticia-slug-intro">
            ...
            <h1 className="noticia-slug-title">{noticia.titulo}</h1>
            <div className="noticia-slug-meta-row">
              <div className="noticia-slug-date">
                <Calendar className="noticia-slug-date-icon" />{" "}
            ...
            <div className="noticia-slug-body-col">
              <article className="noticia-slug-article">
                ...
                <div className="noticia-slug-source-link-box">
                  ...
                  >
                    Ver fuente original{" "}
                    <ExternalLink className="noticia-slug-source-icon" />
                  </a>
                </div>
              </article>
            </div>
                    ...
                    {noticiasRelacionadas.map((relacionada, index) => (
                      <div key={index} className="noticia-slug-related-item">
                        ...
                        <p className="noticia-slug-related-date">
                          <Calendar className="noticia-slug-related-date-icon" />{" "}
                          {relacionada.fecha}
                        </p>
                      </div>
                    ))}
          ...
          <div className="noticia-slug-footer-grid">
            <div className="noticia-slug-footer-info">
              <h4 className="noticia-slug-footer-title">
                <Newspaper className="noticia-slug-footer-title-icon" /> Puebla
                Noticias
              </h4>
              <p className="noticia-slug-footer-description">
                Sala de prensa oficial con toda la información gubernamental del
                Estado de Puebla.
              </p>
            </div>
            <div className="noticia-slug-footer-links">
              ...
              <ul className="noticia-slug-footer-ul">
                <li>
                  <Link href="#" className="noticia-slug-footer-link">
                    Puebla.gob.mx
                  </Link>
                </li>
                <li>
  ...
  <div className="noticia-slug-social-icons">
    <Link 
      href="#" 
      className="noticia-slug-social-link" 
      aria-label="Seguir en X (Twitter)"
    >
      <svg
        viewBox="0 0 24 24"
        fill="currentColor"
        className="noticia-slug-social-icon"
      >
